...
**Command:** `AutoSyncHangersToRefPlaneCommand`
**Domain:** Hangers
...
- `"-Pipe Hanger"` (Shambaugh standard hangers)
...
- For moving hangers to pipes, use "Sync to Pipes" (AutoSyncHangersToPipesCommand)
