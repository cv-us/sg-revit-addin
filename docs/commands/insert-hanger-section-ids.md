...
**Command class:** `SSG_FP_Suite.Commands.Hangers.InsertHangerSectionIDsCommand`
**Migrated from:** `AutoInsert - Hanger Section ID's.dyn`
...
|---------|--------------|----------------|
| Speed | Slow — Data-Shapes + Python | Fast — native C# |
| Dependencies | Data-Shapes | Zero |
| UI | Data-Shapes selection + info dialog | Direct Revit PickObjects |
| Processing | Same logic | Same logic, no dialog needed |
