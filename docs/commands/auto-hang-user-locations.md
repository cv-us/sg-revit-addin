...
**Command class:** `SSG_FP_Suite.Commands.Hangers.AutoHangUserLocationsCommand`
**Migrated from:** `Auto Hang - User Locations - Underside of Structural - RayBounce.dyn` (V11)
...
| Feature | Dynamo Script (V11) | Plugin Command |
|---------|-------------------|----------------|
| Speed | Slow — Data-Shapes UI + Python intersection math | Fast — native C# intersection + WinForms |
| Dependencies | Data-Shapes + BimorphNodes | Zero external dependencies |
| UI | Multi-step Data-Shapes form | Single WinForms dialog |
| Selection | Separate prompts for pipes and lines | Single combined selection |
| Intersection | Python 2D line math | IntersectionHelpers (analytical segment intersection) |
| Raybounce | BimorphNodes LinkElement.ByRayBounce | Native ReferenceIntersector |
