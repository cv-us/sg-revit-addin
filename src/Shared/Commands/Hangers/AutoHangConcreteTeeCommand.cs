...
namespace SSG_FP_Suite.Commands.Hangers
{
    ...
    public class AutoHangConcreteTeeCommand : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                // ── Step 3: Show dialog ──
                using (var dialog = new AutoHangConcreteTeeDialog(
            ...
            Solid solid, Transform linkTransform, List<StemSurface> results)
        {
            ...
            foreach (Face face in solid.Faces)
            {
                ...
                // Sample points at 20% and 80% along V parameter (matching Dynamo's 0.2, 0.8)
