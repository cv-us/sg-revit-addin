...
namespace SSG_FP_Suite.Commands.Hangers
{
    ...
    public class AutoSyncHangersToStructuralCommand : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            // ── Show dialog ──
            using (var dlg = new AutoSyncHangersToStructuralDialog(hangers.Count))
            {
        ...
        /// </summary>
        private string GetTypeCode(BuiltInCategory hitCat, AutoSyncHangersToStructuralDialog dlg)
        {
            switch (hitCat)
            {
