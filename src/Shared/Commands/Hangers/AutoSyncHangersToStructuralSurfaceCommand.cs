...
namespace SSG_FP_Suite.Commands.Hangers
{
    ...
    public class AutoSyncHangersToStructuralSurfaceCommand : IExternalCommand
    {
        /// <summary>
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                // ── Show dialog ──
                using (var dlg = new AutoSyncHangersToStructuralSurfaceDialog(
        ...
        /// </summary>
        private string GetTypeCode(BuiltInCategory hitCat, AutoSyncHangersToStructuralSurfaceDialog dlg)
        {
            switch (hitCat)
            {
