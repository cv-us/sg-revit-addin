...
{
    /// <summary>
    /// Dialog for the Auto Trapeze Hang — Unistrut — Auto Spaced command.
    ///
    /// Same as the standard trapeze dialog plus three unistrut-specific inputs:
    ///   - Distance down to top of unistrut (inches)
    ...
    {
        private const string MemKey = "TrapezeUnistrut";
        ...
        private void InitializeForm(
            ...
            IList<string> linkNames)
        {
            Text = "Auto Trapeze Hang — Unistrut — Auto Spaced";
            ...
            // ── Trapeze Family ──
            AddLabel("Unistrut Trapeze Family:", 15, y);
            ...
            txtCustomSpacing = new TextBox { Left = 265, Top = 64, Width = 60, Enabled = false };
            ...
            txtTrapezeTypeCode = new TextBox { Left = inputX, Top = y - 2, Width = 80, Text = "21F" };
            ...
            y += 20;
            var pnlExtFrom = MakeRadioPanel(y, 44);
            rbExtFromFraming = new RadioButton
            {
                Text = "Middle of Framing",
                Left = 15, Top = 0, AutoSize = true, Checked = true
            };
            pnlExtFrom.Controls.Add(rbExtFromFraming);
            rbExtFromRod = new RadioButton
            {
                Text = "Hanger Rod",
                Left = 15, Top = 22, AutoSize = true
            };
            pnlExtFrom.Controls.Add(rbExtFromRod);
            y += 48;
        ...
        private Panel MakeRadioPanel(int top, int height)
        {
            var p = new Panel
            {
                Left = 15, Top = top, Width = 590, Height = height,
                Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right
            };
            Controls.Add(p);
            return p;
        ...
        private void BtnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select a unistrut trapeze hanger family.", "Validation",
