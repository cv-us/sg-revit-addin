...
namespace SSG_FP_Suite.Commands.Hangers
{
    ...
    /// with Shambaugh "-Pipe Hanger - Standard" family instances. Transfers
    ...
    public class AutoSwapHydraCADHangersCommand : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            // ── Show dialog ──
            using (var dlg = new AutoSwapHydraCADHangersDialog(hydraCADHangers.Count))
            {
        ...
        /// The Dynamo script finds Line geometry within the element, then gets PointAtParameter(0.5).
        /// </summary>
