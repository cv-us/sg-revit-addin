...
namespace SSG_FP_Suite.Commands.Hangers
{
    ...
    public class AutoHangAtStructuralCommand : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                // ── Step 3: Show dialog ──
                using (var dialog = new AutoHangAtStructuralDialog(hangerFamilies, linkNames))
                {
                    ...
                    using (var tw = new TransactionWrapper(doc, "Auto Hang at Structural"))
                    {
                        ...
                        foreach (Element pipe in pipes)
                        {
                            ...
                            foreach (var framing in framingList)
                            {
                                ...
                                // Rod length = pipe diameter (same as Dynamo script behavior)
