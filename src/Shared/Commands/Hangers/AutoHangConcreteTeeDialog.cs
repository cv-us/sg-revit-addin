...
namespace SSG_FP_Suite.Commands.Hangers
{
    ...
    ///
    /// Migrated from: "Custom Auto Hang - Concrete Tees (Warped) - Side of Stems - User Locations.dyn"
    /// </summary>
    public class AutoHangConcreteTeeDialog : Form
    {
        // ── Results ──
        ...
        public AutoHangConcreteTeeDialog(
