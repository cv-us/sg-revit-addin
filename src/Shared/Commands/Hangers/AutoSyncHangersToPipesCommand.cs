...
namespace SSG_FP_Suite.Commands.Hangers
{
    ...
    public class AutoSyncHangersToPipesCommand : IExternalCommand
    {
        ...
        private void SetHangerRotation(Document doc, FamilyInstance hanger, XYZ point, double degrees)
        {
            ...
            // FamilyInstance.SetRotation in Dynamo sets absolute rotation,
            // so we need to compute the delta from current rotation
