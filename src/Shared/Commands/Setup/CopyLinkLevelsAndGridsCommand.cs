...
namespace SSG_FP_Suite.Commands.Setup
{
    ...
    public class CopyLinkLevelsAndGridsCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                using (var dialog = new CopyLinkLevelsAndGridsDialog(linkNames, gridTypeNames))
                {
                    ...
                    bool doLevels = dialog.Mode != CopyLinkLevelsAndGridsDialog.ImportMode.GridsOnly;
                    bool doGrids = dialog.Mode != CopyLinkLevelsAndGridsDialog.ImportMode.LevelsOnly;
                    ...
                    if (doLevels && newLevels.Count > 0 &&
                        dialog.LevelSelectionMode == CopyLinkLevelsAndGridsDialog.SelectionMode.SelectSpecific)
                    {
                    ...
                    if (doGrids && newGrids.Count > 0 &&
                        dialog.GridSelectionMode == CopyLinkLevelsAndGridsDialog.SelectionMode.SelectSpecific)
                    {
