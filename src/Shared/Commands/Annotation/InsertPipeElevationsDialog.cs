...
namespace SSG_FP_Suite.Commands.Annotation
{
    ...
    ///
    /// Migrated from: "AutoInsert - Pipe and Fitting Elevations.dyn"
    /// </summary>
    public class InsertPipeElevationsDialog : Form
    {
        // ── Results ──
        ...
        public InsertPipeElevationsDialog(List<string> levelNames, List<string> refPlaneNames)
        {
