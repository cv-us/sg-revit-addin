...
namespace SSG_FP_Suite.Commands.Annotation
{
    ...
    ///
    /// Migrated from: "Custom AutoInsert - Flexible Drop Lengths-Dalmatian Fire Style.dyn"
    /// </summary>
    public class InsertFlexDropLengthsDalmatianDialog : Form
    {
        // ── Results ──
        ...
        public InsertFlexDropLengthsDalmatianDialog(int sprinklerCount)
        {
