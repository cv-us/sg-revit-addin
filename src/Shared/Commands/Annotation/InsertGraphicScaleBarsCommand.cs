...
namespace SSG_FP_Suite.Commands.Annotation
{
    ...
    public class InsertGraphicScaleBarsCommand : IExternalCommand
    {
        private const string ScaleBarFamilyName = "-Graphic Scale Bar";

        // Placement offsets (feet) — from Dynamo script
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                var sheetItems = allSheets
                    .Select(s => new InsertGraphicScaleBarsDialog.SheetItem
                    {
                ...
                var dialog = new InsertGraphicScaleBarsDialog(sheetItems);
